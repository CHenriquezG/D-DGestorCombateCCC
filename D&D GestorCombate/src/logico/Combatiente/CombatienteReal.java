...
public class CombatienteReal extends Combatiente {
    ...
    public CombatienteReal(String nombre,String nombreJugador,String imagen, String clase, int bini, int PG, int arm, int fue, int inte, int des, int cons, int car, int id) {
